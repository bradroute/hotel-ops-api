...
import { checkinBody, checkoutBody, roomNumberParams } from '../schemas/rooms.js';
...
router.post(
  '/:room_number/checkin',
  validate({ params: roomNumberParams, body: checkinBody }),
  async (req, res) => {
 ...
 */
router.post(
  '/:room_number/checkout',
  validate({ params: roomNumberParams, body: checkoutBody }),
  async (req, res) => {
    const room_number = String(req.params.room_number || '').trim();
